...
BerkeleyDB is required for the wallet. To install BerkelyDB on Ubuntu, execute the following commands:
...
../dist/configure --enable-cxx --disable-shared --with-pic --prefix=/home/${USER}/garlicoin/db4/
make install
```
